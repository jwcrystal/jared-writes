...
The publish script uses `rsync` incremental copy. It syncs new and changed Markdown files, but intentionally does not delete target files when a source file is removed.
